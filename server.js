...
3b. CATEGORY FAMILIES — do not be pedantic about near-synonyms and subtypes. When the secret IS an instance or subtype of the category the player asks about, never answer a flat NO. A battle belongs to the war/armed-conflict family: if the secret is the Battle of Marathon and the player asks "Is it a war?" or "A war?", answer PARTLY (it is a battle within a war — a flat NO would wrongly eliminate all military events; a battle is not itself an entire war, so PARTLY, not YES). Same spirit for other families: battle/war/conflict/fighting, film/movie, ship/boat, plane/aircraft, epidemic/pandemic/disease, storm/hurricane/cyclone, king/monarch/ruler, painting/artwork. Answer YES when the secret genuinely is the named thing, PARTLY when it is a closely related subtype or part, NO only when it truly does not belong to the family.
...
7b. TIME-DISTANCE QUESTIONS — apply consistent semantics and never answer UNCLEAR. "Did it happen X years ago?" (or just "X years ago") means APPROXIMATELY X years ago (within about a quarter either way). "More than / over / at least X years ago" and "Is it older than X years?" are THRESHOLD questions. Example — the secret happened in 490 BC (about 2,500 years ago): "300 years ago?" → NO (it was far longer ago than that); "More than 300 years ago?" → YES; "Over 2,000 years ago?" → YES; "About 2,500 years ago?" → YES. Answer century questions ("19th century?") by the actual date.
